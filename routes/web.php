...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('monthlypregnancy', App\Http\Controllers\MonthlypregnancyController::class);
    ...
    Route::prefix('tests')->group(function () {
        ...
        Route::get('/in/{id}/image', [App\Http\Controllers\InTestController::class, 'getImageFile'])->name('in.displayImage');
