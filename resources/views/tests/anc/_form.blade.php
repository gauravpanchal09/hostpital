    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="form-group @error('patient_id') has-error @enderror">
                ...
                <select name="patient_id" class="form-control select2" style="height:40px">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">ANC Test History</h4>
            </div>
                                            ...
                                            <div class="box-header">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 text-red">
                                                        ...
                                                        <strong>{{ $curr['old'] }}</strong>
                                                    </div>
                                                    <div class="col-md-4 text-green">
                                                        <i class="icon fa fa-check"></i>
                                                        <strong>{{ $curr['new'] }}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
